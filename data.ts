...
export const QUIZZES: QuizData[] = [
  ...
  },
  {
    ...
    description: 'Advanced Lecture 5: Comprehensive analysis of stability and retention forms.',
    icon: '🏛️',
    isExternal: false,
    questions: [
      ...
      { id: '5-21', text: 'Roughening the fitting surface of a restoration is typically done with:', options: ['A) 50 μm alumina particles', 'B) 100 μm diamond burs', 'C) Hydrogen peroxide', 'D) Distilled water'], answer: 'A' },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: '8-27', text: 'A "Radial Shoulder" is a:', options: ['A) Beveled margin', 'B) Modified shoulder with small radius and 90° cavosurface', 'C) Sharp 45° angle', 'D) Knife edge'], answer: 'B' },
